  ...
  .responsive {
	...
	<body>
		...
		<br><br><br>
			...
			<img src="car/Dukati/Hypermotard/ducati-hypermotard-950-png.png" alt="Snow" style="width:100%">
			<button class="btn" name="model" value="Ducati Hypermotard 950" >สั่งจอง</button>
			</form>
			
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="img_5terre.jpg"></a>
				<div class="desc">ราคา 529,000 บาท 
				
				&emsp;<a href="car/Dukati/Hypermotard/Hypermotard.php" class="inpic"> รายละเอียดเพิ่มเติม<a>
				</div>
		...
		<br><br><br><br><br>
			<div class="container">
			<form action="Order.php" method="POST">
			<h2>Ducati XDiavel 2019</h2>
			<img src="car/Dukati/XDiavel/Ducati-XDiavel-2019.png" alt="Snow" style="width:100%">
			<button class="btn" name="model" value="Ducati XDiavel 2019" >สั่งจอง</button>
			</form>
			<div class="responsive">
				<div class="gallery">
					<a target="_blank" href="img_5terre.jpg"></a>
				<div class="desc">ราคา 898,000 บาท 
				
				&emsp;<a href="car/Dukati/XDiavel/XDiavel.php" class="inpic"> รายละเอียดเพิ่มเติม<a>
				</div>
